...
\section{Zweck des Vereins}
  \begin{itemize}
    \item Zweck des Vereins ist die Erforschung, Verbreitung und Anwendung freier Netzwerktechnologien sowie die Verbreitung, Anwendung und Vermittlung von Wissen über Netzwerke sowie kultureller Inhalte. 
    ...
    \item Austausch mit anderen Gruppen und Vereinigungen
  \end{itemize}
...
\section{Gemeinnützigkeit}
  \begin{itemize}
   ...
   \item Er ist selbstlos tätig und verfolgt nicht in erster Linie eigenwirtschaftliche Zwecke. 
...
\section{Mitgliedschaft}
  \begin{itemize}
   \item Mitglieder des Vereins können natürliche und juristische Personen werden, die sich bereit erklären, die Vereinszwecke und - ziele aktiv, finanziell oder materiell zu unterstützen. 
   ...
   \item Die jeweils aktuelle Satzung wird an geeigneter Stelle den Mitgliedern verfügbar gemacht.
   \item Fördermitglied des Vereins kann jede natürliche oder juristische Person werden, die sich mit den Zielen des Vereins verbunden fühlt und den Verein finanziell und ideell unterstützen will. Die Mitgliedschaft ist in Textform (§ 126b BGB) auf Papier oder elektronisch zu beantragen. Über den Antrag entscheidet der Vorstand.
